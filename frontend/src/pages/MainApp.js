...
export const MainApp = () => {
    ...
    return (_jsxs("div", { className: "app theme-blue", children: [_jsx("header", { className: "app-header", children: _jsxs("div", { className: "header-content", children: [_jsxs("div", { className: "app-logo", onClick: () => navigate('/home'), style: { cursor: 'pointer' }, children: [_jsx("img", { src: "/assets/pisa-logo.png", alt: "PISA Insight Logo", className: "header-logo-img" }), _jsx("span", { className: "app-title", children: "PISA Insight" })] }), _jsxs("nav", { className: "navigation", children: [_jsx("button", { className: `nav-link ${currentPage === 'home' ? 'active' : ''}`, onClick: () => navigate('/home'), children: language === 'th' ? 'หน้าแรก' : 'Home' }), userRole === 'teacher' ? (_jsx("button", { className: `nav-link ${currentPage === 'home' && subpath?.includes('create-classroom') ? 'active' : ''}`, onClick: () => navigate('/create-classroom'), children: language === 'th' ? 'ห้องเรียนของฉัน' : 'My Classrooms' })) : (_jsxs(_Fragment, { children: [_jsx("button", { className: `nav-link ${currentPage === 'question' ? 'active' : ''}`, onClick: () => navigate('/home/practice'), children: language === 'th' ? 'ฝึกฝน' : 'Practice' }), userRole === 'student' && (_jsx("button", { className: `nav-link ${subpath?.includes('join-classroom') ? 'active' : ''}`, onClick: () => navigate('/join-classroom'), children: language === 'th' ? 'เข้าร่วมห้องเรียน' : 'Join Classroom' }))] })), _jsx("button", { className: "nav-link language-toggle", onClick: () => setLanguage(language === 'th' ? 'en' : 'th'), children: language === 'th' ? '🇬🇧 EN' : '🇹🇭 ไทย' }), _jsxs("div", { className: "user-menu", children: [_jsx("span", { className: "user-email", children: user?.displayName ? (_jsxs(_Fragment, { children: [_jsx("span", { style: { fontWeight: 'bold' }, children: user.displayName }), _jsx("br", {}), _jsx("small", { style: { opacity: 0.8 }, children: user.email })] })) : (user?.email) }), _jsx("button", { className: "nav-link logout-btn", onClick: handleLogout, children: language === 'th' ? '🚪 ออกจากระบบ' : '🚪 Logout' })] })] })] }) }), _jsx("main", { className: "app-main", children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(HomePage, {}) }), _jsx(Route, { path: "/practice", element: isLoadingProposition ? (_jsxs("div", { className: "loading-container", children: [_jsx("div", { className: "loading-spinner" }), _jsx("p", { children: language === 'th' ? 'กำลังโหลดคำถาม...' : 'Loading question...' })] })) : proposition ? (_jsx(QuestionPage, { question: activeQuestion, studentId: studentId, proposition: proposition })) : (_jsxs("div", { className: "error-container", children: [_jsx("h2", { children: language === 'th' ? 'ไม่สามารถโหลดคำถามได้' : 'Cannot load question' }), _jsx("p", { children: language === 'th' ? 'กรุณาลองอีกครั้งหรือติดต่อผู้ดูแลระบบ' : 'Please try again or contact administrator' }), _jsx("button", { onClick: () => navigate('/home'), className: "btn btn-primary", children: language === 'th' ? 'กลับสู่หน้าหลัก' : 'Back to Home' })] })) })] }) }), _jsx("footer", { className: "app-footer", children: _jsx("p", { children: "\u00A9 2024 PISA Insight Analyzer | AI-Powered Learning" }) })] }));
};
