...
import { getExamQuestions, getRandomExamQuestion } from '../services/examQuestionService';
...
export const PracticePage = () => {
    ...
    return (_jsx("div", { className: "auth-page", children: _jsx("div", { className: "page-container", children: _jsxs("div", { className: "page-card", children: [_jsx("h2", { className: "auth-subtitle", children: "Practice Exam Questions" }), _jsxs("div", { className: "teacher-actions", children: [_jsx("button", { onClick: pickRandom, className: "btn btn-primary", style: { marginRight: 8 }, children: "Pick Random" }), _jsx(Link, { to: "/", className: "btn btn-outline", children: "Back Home" })] }), loading && _jsx("div", { children: "Loading propositions..." }), !loading && !selected && (_jsxs("div", { children: [_jsx("h3", { children: "Available Exam Questions" }), _jsx("div", { className: "proposition-list", children: questions.map((q, idx) => (_jsxs("div", { className: "proposition-item", children: [_jsxs("h4", { children: [q.questionText.substring(0, 120), q.questionText.length > 120 ? '...' : ''] }), _jsxs("div", { className: "proposition-meta", children: [q.category, " \u2022 ", q.difficulty, q.questionNumber && ` • Q${q.questionNumber}`] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'flex-end', gap: 8 }, children: [_jsx(Link, { to: `/practice/question/${q.id || ''}`, className: "btn btn-outline", children: "Open" }), _jsx("button", { className: "btn btn-primary", onClick: () => setSelected(q), children: "Practice" })] })] }, idx))) })] })), selected && (_jsxs("div", { children: [_jsx("div", { className: "teacher-actions", style: { marginBottom: 16 }, children: _jsx("button", { onClick: () => setSelected(null), className: "btn btn-outline", children: "Back to list" }) }), _jsx(QuestionPage, { question: {
