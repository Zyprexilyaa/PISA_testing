...
onAnalysisComplete, // NEW: destructure callback
    ...
    return (_jsx("div", { className: "question-page", children: _jsxs("div", { className: "question-container", children: [_jsxs("div", { className: "question-section", children: [_jsx("h1", { children: t('question') }), _jsxs("div", { className: "question-content", children: [question.questionImage && (_jsx("img", { src: question.questionImage, alt: "Question", className: "question-image" })), _jsx("p", { className: "question-text", children: question.questionText }), proposition?.sourceType === 'pdf' && !question.questionImage && (_jsxs("div", { className: "question-context", style: { backgroundColor: '#fff4e5', borderColor: '#f59e0b' }, children: [_jsx("strong", { children: "Note:" }), _jsx("p", { children: "This PISA question may depend on an image or diagram in the PDF. Please open the source PDF to view the full content and answer accurately." })] })), proposition?.sourceType === 'pdf' && proposition?.pdfUrl && (_jsxs("div", { className: "question-context", children: [_jsx("strong", { children: "PDF Question Source:" }), _jsx("p", { children: _jsx("a", { href: proposition.pdfUrl, target: "_blank", rel: "noreferrer", children: proposition.pdfFileName || 'Open PDF' }) })] })), question.context && (_jsxs("div", { className: "question-context", children: [_jsx("strong", { children: "Context:" }), _jsx("p", { children: question.context })] }))] })] }), !analysisResult && (_jsxs("div", { className: "recording-section", children: [_jsx("h2", { children: t('recordAnswer') }), _jsx("p", { className: "instructions", children: t('instructions') }), _jsxs("div", { className: "input-method-selector", children: [_jsxs("label", { children: [t('selectInputMethod'), ":"] }), _jsxs("div", { className: "method-buttons", children: [_jsxs("button", { className: `method-btn ${inputMethod === 'voice' ? 'active' : ''}`, onClick: () => setInputMethod('voice'), children: ["\uD83C\uDFA4 ", t('voiceRecording')] }), _jsxs("button", { className: `method-btn ${inputMethod === 'text' ? 'active' : ''}`, onClick: () => setInputMethod('text'), children: ["\u2328\uFE0F ", t('typingAnswer')] })] })] }), inputMethod === 'voice' && (_jsx(AudioRecorder, { onRecordingComplete: handleRecordingComplete, disabled: isSubmitting || isAnalyzing })), inputMethod === 'text' && (_jsx("textarea", { className: "text-input", value: textAnswer, onChange: (e) => setTextAnswer(e.target.value), placeholder: t('typeYourAnswer'), disabled: isSubmitting || isAnalyzing, rows: 6 })), error && _jsx("div", { className: "error-alert", children: error }), _jsx("button", { onClick: handleSubmitAnswer, disabled: (inputMethod === 'voice' && !audioBlob) ||
